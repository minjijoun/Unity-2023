...
public class Dialog_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Ex/Dialog.xlsx";
	private static readonly string exportPath = "Assets/Ex/Dialog.asset";
		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(1); p.speakerUlindex = (int)(cell == null ? 0 : cell.NumericCellValue);
